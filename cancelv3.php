<?php
/*
Požadavek slouží k vystornování Žádosti (Application)
Volat jde u všech žádostí kromě zamítnutých se stateReason = REJECTED
...
$url = $url_base . '/financing/v1/applications/' . $applicationID . '/cancel';

<?php
/*
Dotaz slouží ke zjištění stavu Žádosti = Application
Hledaný stav je stateReason a může nabývat stavů:
...
$url = $url_base . '/fakeshop/rest/applications/' . $applicationID . '/changeState';

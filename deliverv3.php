<?php
/*
Požadavek slouží k nastavení stavu Žádosti (Application) na Doručeno klientovi (READY_DELIVERED)
Volat jde pouze u žádostí se stateReason = ready_to_ship
Pozn.: i u již doručených/proplacených nestornovaných žádostí je požadavek korektně zpracován

!! POZOR - nelze použít po tom, co byl u žádosti použit skript sendv3.php (jedná se o jiný proces vyskladnění)
...
$url = $url_base . '/financing/v1/applications/' . $applicationID . '/order/deliver';
...
if (!curl_errno($ch)) {
  switch ($http_code = curl_getinfo($ch, CURLINFO_HTTP_CODE)) {
    case 200:
    echo 'Soubor deliverv3 => HTTP code : ', $http_code, ' # OK', '<br />';
      break;
    default:
